...
echo -e "\n${YELLOW}${BOLD}Important:${NC} ${BOLD}Reboot${NC} your system to apply all changes"
echo -e "  * After reboot, run: "
echo -e "  *     ${BOLD}pocs weather setup${NC}"
echo -e "  *     ${BOLD}pocs mount setup${NC}"
echo -e "  *     ${BOLD}pocs camera setup${NC}"
echo ""
