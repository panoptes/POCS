...
class AAGCloudSensor(object):
    ...
    def save(self):
        ...
        weather_data = {
            ...
            'data': {
                'Safe': self.safe,
                'Ambient Temperature': self.ambient_temp,
                'Sky Temperature': self.sky_temp,
                'Rain Frequency': self.rain_frequency,
                'Wind Speed': self.wind_speed,
                'Internal Voltage': self.internal_voltage,
                'LDR Resistance': self.LDR_resistance,
                'Rain Sensor Temperature': self.rain_sensor_temp,
                'PWM': self.PWM,
                'E1': self.errors['!E1'],
                'E2': self.errors['!E2'],
                'E3': self.errors['!E3'],
