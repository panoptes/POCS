...
def upload_image(
    ...
    Args:
        ...
        bucket_path (str): Destination path within the bucket (object name),
            e.g. "images/2025/09/foo.jpg".
        bucket_name (str): Name of the target GCS bucket. Defaults to
            "panoptes-images-incoming".
    ...
    Notes:
        Ensure that application default credentials are configured (e.g., via
        GOOGLE_APPLICATION_CREDENTIALS) or the environment supports implicit credentials
