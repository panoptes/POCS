...
# Link the needed POCS folders from the installed package location.
ln -sf "${PANDIR}/src/panoptes/pocs/conf_files" "${HOME}"
ln -sf "${PANDIR}/src/panoptes/pocs/resources" "${HOME}"
ln -sf "${PANDIR}/notebooks" "${HOME}"
