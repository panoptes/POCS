...
class Camera(AbstractCamera):  # pragma: no cover

    """ DSLR camera class.

     This class uses gphoto2 by default and can act as an abstract DSLR interface
    ...
    def load_properties(self):
        ...
        self.properties = parse_dslr_gphoto2_config(self.command(command))
...
def parse_dslr_gphoto2_config(lines):  # pragma: no cover
    yaml_string = ''
    for line in lines:
