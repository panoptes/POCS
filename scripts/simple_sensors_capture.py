...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-d", "--delay", dest="delay", default=1.0, type=float, help="Interval to read sensors")
    parser.add_argument(
        "--use-mongo", dest="use_mongo", default=False, action='store_true', help="Store to mongo")
    parser.add_argument(
        "--send-message",
        dest="send_message",
        default=False,
    ...
    parser.add_argument(
        "--filename", default="simple_sensor_capture.json", help="Filename to store json output")
    parser.add_argument(
        '-v', '--verbose', action='store_true', default=False, help="Print results to stdout")
