...
class TestMount(object):
    ...
    def test_get_tracking_correction(self):
        offsets = [
        ...
        for offset, correction in zip(offsets, corrections):
            ...
            correction_info = self.mount.get_tracking_correction(offset_info, pointing_ha)
    ...
    def test_get_tracking_correction_custom(self):
        min_tracking = 105
        max_tracking = 950
